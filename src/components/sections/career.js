...
export default function Career() {
    ...
    return <>
        ...
        {event(isTabletOrMobile, "3ZMedia", "I was in charge of the back-end, and front-end development of the application called HoneyBits, based on iOS. The purpose of this application was to serve as a store for honey-based products.", <GiHoneypot />, "Jun. 2017", false, "Java | Swift Developer")}
    </>
}